...
#%%
### type your answer here
df_top15 = df_can.sort_values(by='Total', ascending=False, inplace=False).head(15)['Total'].transpose()
...
#     # place text at the end of bar (subtracting 47000 from x, and 0.1 from y to make it fit within the bar)
    plt.annotate(label, xy=(value - 19000, index - 0.10), color='BLACK')
# -->
# 
# <!--
plt.show()
